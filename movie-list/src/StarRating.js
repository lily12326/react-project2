...
//outside the hooks, so that the object won't regenerate repeatily everytime the function is called/
...
export default function StarRating({
    ...
    defaultRating = 0,
    onSetRating = () => { } }) {
    //setting default value using destructing method /always remember to give default value

    //initialize the state with props(defaultRating)
